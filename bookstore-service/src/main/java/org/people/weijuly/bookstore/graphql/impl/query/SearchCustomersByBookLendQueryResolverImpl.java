...
@Component
public class SearchCustomersByBookLendQueryResolverImpl implements SearchCustomersByBookLendQueryResolver {

    @Autowired
    CustomerService customerService;

    @Override
    public CustomersResultModel searchCustomersByBookLend(String bookId) throws Exception {
        try {
            return customerService.searchCustomersByBookLend(bookId);
