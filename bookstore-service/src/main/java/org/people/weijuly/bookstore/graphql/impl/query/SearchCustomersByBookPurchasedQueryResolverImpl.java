...
@Component
public class SearchCustomersByBookPurchasedQueryResolverImpl implements SearchCustomersByBookPurchasedQueryResolver {

    @Autowired
    CustomerService customerService;

    @Override
    public CustomersResultModel searchCustomersByBookPurchased(String bookId) throws Exception {
        try {
            return customerService.searchCustomersByBookPurchased(bookId);
